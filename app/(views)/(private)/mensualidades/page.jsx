...
import { mensualidadescolumns as columns } from "@/app/_components/Datatable/Columns/mensualidades";
import Datatable from "@/app/_components/Datatable/datatable";

export default async function Page() {

    const data = await fetchRequest("/mensualidades", "GET", null);
    ...
    const mensualidades = data.message;
